...
def init_eval(config, type_of_spec, epsilon, attack_model, model_version, attack, dataset, feature, q1, q2, eps1, eps2):
    ...
    if attack != 'Ens2D' and attack != 'Ens1D':
        ...
        RawNet_eval(rawnet_model, save_path, device, config, type_of_spec, epsilon, attack_model, attack, dataset, feature, q1, q2, eps1, eps2)
...
if __name__ == '__main__':
    ...
    attack_model = 'ResRaw'  #'ResNet' or 'SENet'
    epsilon = None
